...
- [ ] Confirm physical RGB appearance and that blinking red has stopped.
  Sequencer control state remains correct; visible LEDs have not been observed.
...
- [ ] Verify physical HDMI unplug/replug recovery, including the splitter and
  receiver, and source mode changes.
...
- [ ] Verify HDMI OUT audio and measure passthrough latency independently of
  OBS preview. Video confirmation does not establish either result.
...
The remaining hardware checks require source playback, physical LED observation,
source/cable changes or a full power cycle. Passing registers, compilation and
